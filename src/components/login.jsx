...
const Login = () => {
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',gap:'10px',backgroundColor:'lavender',height:'787px'}}>
      ...
      <button style={{border:'solid 1px',borderRadius:'10px'}} onClick={handleSubmit}>Login</button> 

      <button style={{border:'solid 1px',borderRadius:'10px'}}onClick={redirecter}>New user</button> 
